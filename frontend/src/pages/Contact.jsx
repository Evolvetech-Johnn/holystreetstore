          ...
          <div>
            <div className={componentStyles.card}>
              <div className="p-8">
                ...
                <form onSubmit={handleSubmit} className={styles.spacingY}>
                  <div>
                  ...
                  <button
                    ...
                    className={`${componentStyles.btnPrimary} w-full ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''}`}
                  >
                ...
                <div className="space-y-6">
                  <div className={styles.flexStart}>
                    <div className="flex-shrink-0">
                      <div className="w-10 h-10 bg-gradient-to-br from-primary-pink to-primary-green rounded-full flex items-center justify-center">
                  ...
                  <div className={styles.flexStart}>
                    <div className="flex-shrink-0">
                      <div className="w-10 h-10 bg-gradient-to-br from-primary-green to-primary-pink rounded-full flex items-center justify-center">
                        <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className={componentStyles.card}>
              <div className="p-8">
                ...
                <div className={`${styles.flexStart} space-x-4`}>
                  <a
                    href="#"
                    className="w-10 h-10 bg-gradient-to-br from-primary-pink to-primary-green rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform"
                  >
                  ...
                  <a
                    href="#"
                    className="w-10 h-10 bg-gradient-to-br from-primary-green to-primary-pink rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform"
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
