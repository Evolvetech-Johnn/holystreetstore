      ...
      <div className={`${styles.container} py-12`}>
        <div className={`${styles.gridContainer} ${styles.gridCols4} gap-8`}>
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className={`text-2xl font-bold mb-4 ${componentStyles.gradientText}`}>
              Holy Street
            </h3>
            <p className="text-gray-400 mb-6 max-w-md">
              Moda que expressa sua personalidade única. Peças exclusivas para quem não tem medo de ser diferente.
            </p>
            <div className={`${styles.flexRow} ${styles.spacingX}`}>
              <a 
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className={`${styles.flexBetween} flex-col md:flex-row gap-4`}>
            <p className="text-gray-400 text-sm">
              © {currentYear} Holy Street. Todos os direitos reservados.
            </p>
            <p className="text-gray-400 text-sm">
              Desenvolvido com ❤️ para expressar seu estilo único.
            </p>
          </div>
        </div>
      </div>
